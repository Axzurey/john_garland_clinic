...
<body style="background-color: khaki; overflow-x: hidden;">
    ...
    <div style='display: flex; filter: blur(0px); -webkit-filter: blur(0px); background-image: url("im2.jpg"); width: 100vw; height: 100vh; background-repeat: no-repeat; background-size: cover; background-position: center;'>
    </div>
    <div style="position: absolute; top: 30%; left: 10%; background-color:rgba(255, 255, 255, .9); border-radius: 15px; padding: 2%">
        ...
        <p style="font-weight: bold; font-size:1vw; color: black">Phone: (+1) 416-423-5235</p>
        <p style="font-weight: bold; font-size:1vw; color: black">Email: johngarlandclinic@gmail.com</p>
    </div>
</body>